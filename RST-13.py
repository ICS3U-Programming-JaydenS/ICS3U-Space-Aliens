...
def win_scene(final_score):
    ...
    if final_score == 5:
        ...
        text3 = stage.Text(width=12, height=9, font=None, palette=constants.NEW_PALETTE, buffer=None)
        text3.move(20,80)
        text3.text("EASY MODE WIN? NOT IMPRESSED! PRESS SELECT NEXT TIME")
        text.append(text3)
        
        text4 = stage.Text(width=12, height=9, font=None, palette=constants.NEW_PALETTE, buffer=None)
        text4.move(20,60)
        text4.text("Press SELECT NOW TO TRY AGAIN")
        text.append(text4)
...
def hard_win_scene(final_score):
    # this function is the game over scene
    ...
    if final_score == 6:
        ...
        text2 = stage.Text(width=8, height=9, font=None, palette=constants.NEW_PALETTE, buffer=None)
        text2.move(20,60)
        text2.text("A HARD MODE WIN! ")
        text.append(text2)

        text3 = stage.Text(width=15, height=12, font=None, palette=constants.NEW_PALETTE, buffer=None)
        text3.move(20, 90)
        text3.text("TRUE VICTORY!")
        text.append(text3)
...
def tutorial_scene():
    ...
    text2 = stage.Text(width=9, height=3, font=None, palette=constants.NEW_PALETTE, buffer=None)
    text2.move(30,50)
    text2.text("Blast the Aliens to gain points.To win easy mode you need 5 points.To win HARD mode you NEED 10 POINTS!")
    text.append(text2)


    text5 = stage.Text(width=12, height=9, font=None, palette=constants.NEW_PALETTE, buffer=None)
    text5.move(40,100)
    text5.text("Press SELECT to go back to the beginning")
    text.append(text5)
...
def menu_scene():
    ...
    text2 = stage.Text(width =  11, height = 7, font =None, palette = constants.NEW_PALETTE, buffer=None)
    text2.move(40, 40)
    text2.text("PRESS DOWN FOR TUTORIAL")
    text.append(text2)
    text3 = stage.Text(width = 11, height = 5, font =None, palette = constants.NEW_PALETTE, buffer=None)
    text3.move(40, 110)
    text3.text("PRESS START FOR easy...")
    text.append(text3)
    text4 = stage.Text(width =  11, height = 7, font =None, palette = constants.NEW_PALETTE, buffer=None)
    text4.move(40, 80)
    text4.text("PRESS UP FOR HARD MODE!!!")
    text.append(text4)
...
def game_scene(mode):
    ...
    sound.stop()
    sound.mute(False)
    bike_sound = open("bicycle_bell.wav", 'rb')
    sound = ugame.audio
    sound.stop()
    sound.mute(False)
